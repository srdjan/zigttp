...
pub const commands = [_]Command{
    ...
    .{ .name = "spec-hash", .run = runSpecHashCommand, .category = .machine, .args = "[--json]", .blurb = "Print the semantics-registry hash", .usage = "spec-hash [--json]" },
    .{ .name = "spec-render", .run = runSpecRenderCommand, .category = .machine, .args = "[--out path] [--check path]", .blurb = "Render the semantics registry as a readable TypeScript spec", .usage = "spec-render [--out path] [--check path]" },
