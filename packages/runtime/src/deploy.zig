...
const config_mod = deploy.config;
const types_mod = deploy.types;
const builder = deploy.builder;
const state = deploy.state;
const northflank_adapter = deploy.northflank_adapter;
const oci_image = deploy.oci.image;
const oci_config = deploy.oci.config;
const registry = deploy.oci.registry;
const auth = deploy.auth;
const control_plane = deploy.control_plane;
const autodetect = deploy.autodetect;
const first_run = deploy.first_run;
const io_util = deploy.io_util;
const printer_mod = deploy.printer;
const review_mod = deploy.review;
const spec_diagnostic = deploy.spec_diagnostic;
