...
pub const index_html =
    ...
    \\<section class="grid"><div class="pane"><h2>Verdict</h2><div class="big" id="verdict">...</div><dl id="summary"></dl><h2 style="margin-top:24px">Properties</h2><div id="properties"></div></div><div class="pane"><h2>Proven Surface</h2><div id="surface"></div></div><div class="pane"><h2>Proof Delta</h2><div id="delta"></div><h2 style="margin-top:24px">Generated Tests</h2><p class="empty" id="tests">Download path-generated JSONL tests from <code>/_zigttp/studio/tests.jsonl</code>.</p></div></section>
