...
//! `zigts spec-render --out docs/spec/semantics.spec.ts`.
...
pub fn renderSpecTs(caller: std.mem.Allocator) ![]u8 {
    ...
    try fmt(allocator, w, "// zigts semantics spec - GENERATED from packages/zigts/src/semantics.zig.\n", .{});
    try fmt(allocator, w, "// Do not edit by hand; run `zigts spec-render` to regenerate.\n", .{});
    try fmt(allocator, w, "//\n", .{});
