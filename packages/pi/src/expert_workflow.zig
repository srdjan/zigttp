...
pub fn classify(user_text: []const u8) WorkflowHint {
    ...
    if (containsAny(user_text, &proof_property_needles) or
        containsAny(user_text, &.{ "durable workflow", "zigttp:durable" }))
    {
